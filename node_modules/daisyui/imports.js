...
export const components = {footer,status,collapse,dropdown,avatar,textrotate,otp,chat,alert,radio,button,toast,drawer,checkbox,diff,swap,calendar,label,toggle,validator,filter,skeleton,fileinput,countdown,link,select,mask,hovergallery,progress,table,indicator,list,megamenu,rating,kbd,modal,radialprogress,range,aura,stack,stat,tooltip,breadcrumbs,card,loading,mockup,hero,fieldset,timeline,tab,divider,carousel,hover3d,navbar,textarea,steps,badge,input,fab,menu,dock};
